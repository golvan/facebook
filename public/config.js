window.settings = {
	...
	userdata: {
		...
		sitelogo: "uplus.png",
		sitecaption: "U+ Comms",
		defaultfeedlogo: "upluslogo.jpg",
		defaultfeedcaption: "U+ Comms",
		stories: [
			{
		...
		posts: [
			{
				postedby: "U+ Comms",
				feedimagename: "feed1.png",
				feedpostedbyimgname: "upluslogo.jpg",
				time: "2h",
				postdescription: "With U+ Comms, get high definition channels on the go.",
